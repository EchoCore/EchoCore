...
public:
    ...
    bool OnGossipSelect(Player *pPlayer, Creature *pCreature, uint32 /*uiSender*/, uint32 uiAction)
    {
        switch (uiAction)
        {
            ...
            case 6266: custom_porter_port(1, 2730.27f, -368.802f, 108.886f, 4.07746f, pPlayer, pCreature); break; // Astranaar
            ...
            case 6270: custom_porter_port(0, -973.728f, 1578.15f, 51.92f, 3.99068f, pPlayer, pCreature); break; // StairCase Event
        }
