-- DB/Quest: Fix: The Explorers' League Outpost (11448), We Can Rebuild It (11483) | by Pitcrawler
...
UPDATE `version` SET `db_version` = 'EDB 1.049' WHERE `core_version` = 'EchoCore';
