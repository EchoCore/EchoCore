-- DB/CPP/Quest: Fix: Troll Patrol: The Alchemist's Apprentice (12541) and Lab Work (12557) // Add text for Alchemist Finklestein (28205) | by malcrom
...
-- Correct PrevQuestId for quests of Alchemist Finklestein
...
UPDATE `version` SET `db_version` = 'EDB 1.059' WHERE `core_version` = 'EchoCore';
